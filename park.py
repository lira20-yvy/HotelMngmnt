...
def print_day_tour_packages():
    print("\n1. Swimming Pool Access + Lunch: @ 1999.00 / 2. Guided Nature Walk + Bicycle Access: @ 2499.00 / 3. Beach Volleyball + Snacks: @ 1499.00 / 4. Island Hopping @ 4999.00")

def foods():
    print("\n1. (3 Pax) Unlimited Samgyup and Wings @ 81.00  / 2. (2 Pax) Bundle Spaghetti, Chicken and Fries @ 600.00 / 3. Full day Access Buffet @ 3000.00 / 4. Dinner at Hotel @ 949.00")
...
def main():
    while True:
        ...
        while True:
            ...
            if choice == 1:
                guest_name, phone_number, address, num_adults, num_kids, arrival_date, arrival_time = collect_registration_info()
